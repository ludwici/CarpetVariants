...
public class BlockRegistry {
    ...
    private static Block registerCarpet(String name, Block orig) {
        ...
        Block ret = Registry.register(BuiltInRegistries.BLOCK, fromNamespaceAndPath(MODID, identifier), new CarpetVariantBlock(orig.asItem(), BlockBehaviour.Properties.ofFullCopy(orig)));
