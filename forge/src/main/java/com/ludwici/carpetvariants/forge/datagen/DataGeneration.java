...
public class DataGeneration {
    ...
    public static void onGatherData(GatherDataEvent event) {
        ...
        generator.addProvider(event.includeClient(), new CVBlockStateProvider(generator, existingFileHelper));
        generator.addProvider(event.includeServer(), new CVLootTableProvider(generator));
    }
