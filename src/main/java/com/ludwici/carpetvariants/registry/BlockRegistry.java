...
public class BlockRegistry {
    ...
    private static <T extends Block> RegistryObject<T> registerCarpet(String name, Block orig) {
        return (RegistryObject<T>) BLOCKS.register(name + "_carpet_variant", () -> new CarpetVariantBlock(orig.asItem(), ((CarpetBlock)orig).getColor(), AbstractBlock.Properties.from(orig)));
    }
}
